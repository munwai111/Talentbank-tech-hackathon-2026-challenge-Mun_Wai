...
// Client Component so we can read the resolved theme and pass it to Clerk's
// appearance prop — Clerk renders its own shadow DOM and needs explicit variables.
